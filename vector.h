...
#define vector_resize_m(v, n, val, type) vector_resize(v, n, val, #type)
...
extern void vector_begin(const vector_t __restrict__ v,
			 iterator_t __restrict__ it) __attribute__((leaf))
__attribute__((nonnull(1, 2)));

extern void vector_end(const vector_t __restrict__ v,
		       iterator_t __restrict__ it) __attribute__((leaf))
__attribute__((nonnull(1, 2)));

extern const_iterator_t vector_cend(const vector_t v);
extern const_iterator_t vector_cbegin(const vector_t v);
extern reverse_iterator_t vector_rbegin(const vector_t v);
extern reverse_iterator_t vector_rend(const vector_t v);
extern void *vector_at(vector_t v, size_t n);
extern const void *vector_cat(vector_t v, size_t n);
extern size_t vector_capacity(const vector_t v);
extern int vector_empty(const vector_t v);

extern int vector_push_back(vector_t vector, void *val, const char *type);
extern int vector_pop_back(vector_t vector, void *rmval);
...
extern void vector_flush(vector_t *vector, ctl_delete_cb_t cb);

extern void vector_assign(vector_t v, size_t n, void *val, const char *type);
extern void vector_reserve(vector_t v, size_t size);
extern void vector_resize(vector_t v, size_t new_size, void *val,
			  const char *type);
extern void vector_shrink_to_fit(vector_t v);
extern void vector_swap(vector_t *v1, vector_t *v2);
extern vector_t vector_dup(vector_t v);

extern size_t vector_size(const vector_t vector);
extern size_t vector_length(const vector_t vector);
extern void vector_free(vector_t vector);
extern void vector_delete(vector_t v, ctl_delete_cb_t cb);
